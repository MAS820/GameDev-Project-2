...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/backdrop.png", __ASSET__assets_images_backdrop_png);
		type.set ("assets/images/backdrop.png", AssetType.IMAGE);
		className.set ("assets/images/car.png", __ASSET__assets_images_car_png);
		type.set ("assets/images/car.png", AssetType.IMAGE);
		className.set ("assets/images/road.png", __ASSET__assets_images_road_png);
		type.set ("assets/images/road.png", AssetType.IMAGE);
		className.set ("assets/images/townBG.png", __ASSET__assets_images_townbg_png);
		type.set ("assets/images/townBG.png", AssetType.IMAGE);
...
@:keep @:bind #if display private #end class __ASSET__assets_images_backdrop_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_road_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_townbg_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/images/backdrop.png") #if display private #end class __ASSET__assets_images_backdrop_png extends lime.graphics.Image {}
@:image("assets/images/car.png") #if display private #end class __ASSET__assets_images_car_png extends lime.graphics.Image {}
@:image("assets/images/road.png") #if display private #end class __ASSET__assets_images_road_png extends lime.graphics.Image {}
@:image("assets/images/townBG.png") #if display private #end class __ASSET__assets_images_townbg_png extends lime.graphics.Image {}
